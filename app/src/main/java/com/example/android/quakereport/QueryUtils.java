...
*/
    ...
    public static ArrayList<Quake> extractEarthquakes(String JSON_response) {
        ...
        try {
            ...
            JSONArray contacts = s.getJSONArray("features");
            for (int i = 0; i < contacts.length(); i++) {
                JSONObject c = contacts.getJSONObject(i);
                JSONObject d = c.getJSONObject("properties");
                double mag = d.getDouble("mag");
                String loc = d.getString("place");
                long tim = d.getLong("time");
               ...
               // Date dateObject = new Date(tim);
                ...
                earthquakes.add( new Quake(mag,loc,tim,url));
